...
begin
    ...
    s.changingTransformPencil(40+1, 50);
    s.changingColorPencil(255,0,0);
    s.filling();
    s.changingTransformPencil(60-1, 50);
    s.changingColorPencil(0,255,0);
    s.filling();
    s.changingTransformPencil(50, 60-1);
    s.changingColorPencil(0,0,255);
    s.filling();
    s.changingTransformPencil(50, 40+1);
    s.changingColorPencil(0,255,255);
    s.filling();
    s.changingTransformPencil(50, 40-1);
    s.changingColorPencil(255,200,0);
    s.filling();
                             
    s.changingTransform(50, 50);
    s.changingTransform(100, 100);
    s.fileSave(NameFile);
    s.free;
    s1.free;
